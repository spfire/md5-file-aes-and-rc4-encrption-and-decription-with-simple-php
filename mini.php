...
<body background="world.jpg">
	...
	<input type="button" class="btn" value="Login" onclick="window.location.href='./sign/login.php'" />
	<input type="button" class="btn" value="Register" onclick="window.location.href='md5.php'" /></div>
</body>